...
"                <button onClick={()=>setStatus('idle')} style={{marginTop:28,padding:'12px 28px',borderRadius:999,background:'rgba(255,255,255,0.06)',border:'1px solid rgba(255,255,255,0.1)',color:'white',cursor:'pointer',fontSize:14}}>",
"                  Send Another",
"                </button>",
"              </motion.div>",
"            ) : (",
...
"                    <input required style={inputStyle} placeholder='John Smith' value={form.name} onChange={e=>setForm({...form,name:e.target.value})}",
...
"                    <input required type='email' style={inputStyle} placeholder='john@company.com' value={form.email} onChange={e=>setForm({...form,email:e.target.value})}",
"                      onFocus={e=>(e.target.style.border='1px solid rgba(59,130,246,0.5)')}",
"                      onBlur={e=>(e.target.style.border='1px solid rgba(255,255,255,0.08)')}",
"                    />",
"                  </div>",
...
"                  <select required style={{...inputStyle,cursor:'pointer'}} value={form.type} onChange={e=>setForm({...form,type:e.target.value})}",
"                    onFocus={e=>(e.target.style.border='1px solid rgba(59,130,246,0.5)')}",
"                    onBlur={e=>(e.target.style.border='1px solid rgba(255,255,255,0.08)')}",
"                  >",
...
console.log('Contact.tsx written!');

...
export default function Hero() {
  return (
    <section style={{minHeight:'100vh',display:'flex',alignItems:'center',position:'relative',overflow:'hidden',background:'transparent'}}>
      ...
      <div style={{width:'100%',padding:'0 48px',paddingTop:100}}>
        <div style={{display:'flex',flexDirection:'row',alignItems:'center',gap:48,minHeight:'90vh'}}>
          ...
          <div style={{flex:1,display:'flex',flexDirection:'column',gap:32}}>
            ...
            >
              <span style={{width:6,height:6,borderRadius:'50%',background:'#06B6D4',animation:'pulse 2s infinite'}} />
              Next-Gen Software Studio
            </motion.span>

            <motion.h1
              initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.9,delay:0.35}}
              style={{fontFamily:'Space Grotesk, sans-serif',fontSize:'clamp(42px, 5vw, 72px)',fontWeight:700,lineHeight:1.08,letterSpacing:'-0.02em',margin:0}}
            >

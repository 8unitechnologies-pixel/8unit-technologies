...
export default function About() {
  return (
    <section id="about" style={{padding:'120px 48px',position:'relative',overflow:'hidden'}}>
      ...
      <div style={{maxWidth:1400,margin:'0 auto'}}>
        <div style={{display:'flex',flexDirection:'row',gap:80,alignItems:'center'}}>
          ...
          >
            ...
            <p style={{color:'#94A3B8',fontSize:17,lineHeight:1.75,marginBottom:20}}>
            ...
            <p style={{color:'#94A3B8',fontSize:17,lineHeight:1.75,marginBottom:40}}>
          ...
          <motion.div
            ...
            style={{flex:1,background:'rgba(255,255,255,0.02)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:24,padding:'40px'}}
          >
            ...
            <div style={{display:'flex',flexDirection:'column',gap:20}}>
              {values.map((v, i) => (
                ...
                >
                  ...
                  <span style={{color:'#CBD5E1',fontSize:15,lineHeight:1.6}}>{v}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>

...
"",
"      <div style={{width:'100%',padding:'0 24px',paddingTop:100}}>",
"",
"        {/* MOBILE LAYOUT */}",
"        <div className='mobile-hero' style={{display:'flex',flexDirection:'column',alignItems:'center',minHeight:'90vh',paddingBottom:60}}>",
"",
"          {/* Sphere on mobile - top */}",
"          <motion.div",
"            className='mobile-sphere'",
"            initial={{opacity:0,scale:0.8}} animate={{opacity:1,scale:1}} transition={{duration:1.2,delay:0.2}}",
"            style={{width:'100%',height:300,position:'relative',marginBottom:32}}",
"          >",
"            <div style={{position:'absolute',inset:0,display:'flex',alignItems:'center',justifyContent:'center',pointerEvents:'none'}}>",
"              <div style={{width:280,height:280,borderRadius:'50%',background:'rgba(59,130,246,0.1)',filter:'blur(60px)'}} />",
"            </div>",
"            <FloatingSphere />",
"          </motion.div>",
"",
...
"            style={{display:'flex',flexDirection:'column',gap:24,alignItems:'center',textAlign:'center',width:'100%',maxWidth:600}}",
"          >",
"            <span style={{display:'inline-flex',alignItems:'center',gap:8,padding:'8px 16px',borderRadius:999,background:'rgba(255,255,255,0.04)',border:'1px solid rgba(59,130,246,0.25)',color:'#06B6D4',fontSize:10,fontWeight:500,letterSpacing:'0.15em',textTransform:'uppercase'}}>",
"              <span style={{width:6,height:6,borderRadius:'50%',background:'#06B6D4'}} />",
"              Next-Gen Software Studio",
"            </span>",
"",
"            <h1 style={{fontFamily:'Space Grotesk,sans-serif',fontSize:'clamp(36px,8vw,64px)',fontWeight:700,lineHeight:1.08,letterSpacing:'-0.02em',margin:0}}>",
...
"            </h1>",
"",
"            <p style={{color:'#94A3B8',fontSize:16,lineHeight:1.7,margin:0,maxWidth:480}}>",
...
"            </div>",
"",
"            <div style={{display:'flex',gap:32,paddingTop:16,borderTop:'1px solid rgba(255,255,255,0.06)',width:'100%',justifyContent:'center'}}>",
...
"",
"        {/* DESKTOP LAYOUT */}",
"        <div className='desktop-hero' style={{display:'flex',flexDirection:'row',alignItems:'center',gap:48,minHeight:'90vh'}}>",
"          <motion.div",
...
"          >",
"            <span style={{display:'inline-flex',alignItems:'center',gap:8,padding:'8px 16px',borderRadius:999,background:'rgba(255,255,255,0.04)',border:'1px solid rgba(59,130,246,0.25)',color:'#06B6D4',fontSize:11,fontWeight:500,letterSpacing:'0.15em',textTransform:'uppercase',width:'fit-content'}}>",
"              <span style={{width:6,height:6,borderRadius:'50%',background:'#06B6D4'}} />",
"              Next-Gen Software Studio",
"            </span>",
"            <h1 style={{fontFamily:'Space Grotesk,sans-serif',fontSize:'clamp(42px,5vw,72px)',fontWeight:700,lineHeight:1.08,letterSpacing:'-0.02em',margin:0}}>",
"              <span style={{color:'#ffffff',display:'block'}}>Engineering</span>",
"              <span style={{background:'linear-gradient(135deg,#3B82F6,#06B6D4,#8B5CF6)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',backgroundClip:'text',display:'block'}}>The Future</span>",
"              <span style={{color:'#ffffff',display:'block'}}>Of Digital</span>",
"              <span style={{background:'linear-gradient(135deg,#60A5FA,#06B6D4)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',backgroundClip:'text',display:'block'}}>Innovation</span>",
"            </h1>",
"            <p style={{color:'#94A3B8',fontSize:18,lineHeight:1.7,maxWidth:520,margin:0}}>",
...
"              </motion.a>",
"            </div>",
"            <div style={{display:'flex',gap:40,paddingTop:24,borderTop:'1px solid rgba(255,255,255,0.06)'}}>",
"              {[{value:'5\u2605',label:'Client Rating'},{value:'3+',label:'Years Experience'}].map((stat) => (",
"                <div key={stat.label}>",

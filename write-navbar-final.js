...
"      }}",
"    >",
"      <div style={{maxWidth:1400,margin:'0 auto',padding:'0 20px',display:'flex',alignItems:'center',justifyContent:'space-between',gap:12}}>",
"",
...
"          )}",
"          {isMobile && (",
"            <span style={{fontFamily:'Space Grotesk,sans-serif',fontWeight:600,color:'white',fontSize:14,whiteSpace:'nowrap'}}>",
"              8 Unit Technologies",
"            </span>",
"          )}",
"        </Link>",
...
"              style={{background:'rgba(255,255,255,0.06)',border:'1px solid rgba(255,255,255,0.1)',borderRadius:8,padding:'8px 12px',color:'white',cursor:'pointer',fontSize:13,fontWeight:500}}",
"            >",
...
fs.writeFileSync('src/components/sections/Navbar.tsx', lines.join('\n'));
